import { fetchAnimeReleaseDates } from '@/api'
...
export default {
  ...
  actions: {
    FETCH_ANIME_RELEASE_DATES: ({ commit, state }) => {
      return fetchAnimeReleaseDates(state.pagination.pageSize, state.pagination.currentPage)
        .then(({ count, rows }) => {

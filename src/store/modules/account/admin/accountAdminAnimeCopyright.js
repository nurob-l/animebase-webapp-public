import { fetchAnimeCopyrights } from '@/api'
...
export default {
  ...
  actions: {
    FETCH_ANIME_COPYRIGHTS: ({ commit, state }) => {
      return fetchAnimeCopyrights(state.pagination.pageSize, state.pagination.currentPage)
        .then(({ count, rows }) => {
